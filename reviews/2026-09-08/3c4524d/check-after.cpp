// The review's own native checks, re-run after the fix.
// ONE word changed from `check.cpp`: `unrecognised_spent` -> `origins_refused`,
// a field the fix removes with the design that needed it. Everything else theirs.
